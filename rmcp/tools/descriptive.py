...
@tool(
            ...
            "statistics": {
                ...
                "additionalProperties": {
                    ...
                    "properties": {
                        ...
                        "max": {"type": "number"},
                        "range": {"type": "number"},
                        # null when undefined: skewness/kurtosis need n>=3
    ...
    description="Descriptive statistics: mean, median, SD, quantiles, skewness, kurtosis, and missing counts, optionally by group.",
)
...
@tool(
    ...
    description="Flags outliers by IQR, Z-score, modified Z-score, or Mahalanobis distance for multivariate data.",
)
...
@tool(
    ...
    description="Counts, percentages, and cumulative frequencies for categorical variables.",
)
