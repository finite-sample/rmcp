...
@tool(
    ...
    description="Panel regression with fixed, random, between, or pooling estimators. Handles unbalanced panels and reports a Hausman test.",
)
...
@tool(
    ...
    description="Two-stage least squares (2SLS) for endogenous regressors. Returns first-stage statistics, weak-instrument and overidentification tests.",
)
...
@tool(
    ...
    description="Vector autoregression across multiple time series. Returns impulse response functions, variance decomposition, and Granger causality tests.",
)
