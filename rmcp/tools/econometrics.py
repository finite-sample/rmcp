...
@tool(
    ...
    output_schema={
        ...
        "required": ["coefficients", "std_errors", "t_values", "p_values", "r_squared", "adj_r_squared", "model_type", "robust_se", "n_obs", "n_groups", "time_periods", "formula", "id_variable", "time_variable"],
    ...
    output_schema={
        ...
        "properties": {
            ...
            "weak_instruments": {
                "type": "object",
                "properties": {
                    "statistic": {"type": "number", "description": "Weak instruments test statistic"},
                    "p_value": {"type": "number", "minimum": 0, "maximum": 1, "description": "P-value for weak instruments test"}
                },
            ...
            "wu_hausman": {
                "type": "object",
                "properties": {
                    "statistic": {"type": "number", "description": "Wu-Hausman test statistic"},
                    "p_value": {"type": "number", "minimum": 0, "maximum": 1, "description": "P-value for Wu-Hausman test"}
                },
            ...
            "sargan": {
                "type": "object",
                "properties": {
                    "statistic": {"type": "number", "description": "Sargan test statistic"},
                    "p_value": {"type": "number", "minimum": 0, "maximum": 1, "description": "P-value for Sargan test"}
                },
            ...
            "formula": {
                "type": "string",
                "description": "IV regression formula used"
            },
            "n_obs": {
                "type": "integer",
        ...
        "required": ["coefficients", "std_errors", "t_values", "p_values", "r_squared", "adj_r_squared", "weak_instruments", "wu_hausman", "sargan", "robust_se", "formula", "n_obs"],
        "additionalProperties": False
    },
...
@tool(
    ...
    output_schema={
        ...
        "required": ["equations", "variables", "lag_order", "var_type", "n_obs", "n_variables", "loglik", "aic", "bic", "residual_covariance"],
        "additionalProperties": False
    },
