...
@tool(
    ...
    description="One-sample, two-sample, or paired t-test. Returns the t-statistic, df, p-value, confidence interval, and Cohen's d.",
)
...
@tool(
    ...
    description="One-way, two-way, or repeated-measures ANOVA. Returns F-statistics, p-values, eta-squared, and post-hoc comparisons.",
)
...
@tool(
    ...
    description="Chi-square test of independence or goodness-of-fit. Returns the statistic, df, p-value, expected frequencies, and standardized residuals.",
)
...
@tool(
    ...
    description="Tests normality via Shapiro-Wilk, Kolmogorov-Smirnov, Anderson-Darling, or Jarque-Bera. Shapiro-Wilk is most powerful for small samples.",
)
