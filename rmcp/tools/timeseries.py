...
@tool(
    ...
    description="Fits ARIMA models for forecasting, with automatic or specified orders. Returns forecasts with intervals plus AIC/BIC. Handles seasonal series.",
)
...
@tool(
    ...
    description="Splits a time series into trend, seasonal, and remainder components (additive or multiplicative).",
)
...
@tool(
    ...
    description="Tests stationarity via ADF, KPSS, or Phillips-Perron. ADF tests for a unit root, KPSS for trend stationarity. Run before ARIMA to decide whether to difference.",
)
