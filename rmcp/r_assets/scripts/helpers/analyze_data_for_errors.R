...
if (length(high_missing) > 0) {
    ...
    suggestions <- c(suggestions, paste("High missing values in:", 
...
if (length(char_vars) > 0) {
    suggestions <- c(suggestions, paste("Character variables may need conversion:", 
...
if (length(constant_vars) > 0) {
    ...
    suggestions <- c(suggestions, paste("Constant variables (no variation):", 
