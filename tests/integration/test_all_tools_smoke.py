...
TIME_SERIES_DATA = {
    "values": [100, 102, 98, 105, 108, 110, 95, 100, 103, 107]
}
...
MOCK_RESPONSES = {
    ...
    "lag_lead": {
        "data": {"x_lag1": [None, 1, 2, 3, 4]},
        "lags": 1,
        "variable": "x"
    },
    "difference": {
        "data": {"x_diff": [None, 1, 1, 1, 1]},
        "order": 1,
        "variable": "x"
    },
...
async def test_tool_integration(server, tool_name, test_data):
    ...
    try:
        ...
        with patch('rmcp.r_integration.execute_r_script_async', return_value=mock_response), \
             patch('rmcp.r_integration.execute_r_script_with_image_async', return_value=mock_response):
            ...
            if tool_name in ["scatter_plot", "histogram", "boxplot", "time_series_plot", "correlation_heatmap", "regression_plot"]:
...
async def run_comprehensive_integration_tests():
    ...
    test_cases = [
        ...
        ("logistic_regression", {"data": BINARY_DATA, "formula": "outcome ~ predictor", "family": "binomial"}),
        
        # Statistical Tests (4 tools)
        ("t_test", {"data": BASIC_DATA, "variable": "x", "mu": 0}),
        ("anova", {"data": CATEGORICAL_DATA, "formula": "value ~ category"}),
        ("chi_square_test", {"data": CATEGORICAL_DATA, "test_type": "independence", "x": "category", "y": "value"}),
        ...
        ("winsorize", {"data": BASIC_DATA, "variables": ["x"], "percentiles": [0.1, 0.4]}),
        ...
        ("random_forest", {"data": BINARY_DATA, "formula": "outcome ~ predictor", "n_trees": 100}),
        
        # Econometrics (3 tools)
        ("panel_regression", {"data": PANEL_DATA, "formula": "y ~ x", "id_variable": "id", "time_variable": "time"}),
        ("instrumental_variables", {"data": PANEL_DATA, "formula": "y ~ x", "instruments": ["time"]}),
        ("var_model", {"data": BASIC_DATA, "variables": ["x", "y"], "lags": 1}),
        
        # Visualization (6 tools)
        ("scatter_plot", {"data": BASIC_DATA, "x": "x", "y": "y", "return_image": True}),
        ...
        ("regression_plot", {"data": BASIC_DATA, "formula": "y ~ x", "return_image": True}),
        ...
        ("filter_data", {"data": BASIC_DATA, "conditions": [{"variable": "x", "operator": ">", "value": 2}]}),
        ...
        ("build_formula", {"description": "predict y from x", "analysis_type": "regression"}),
